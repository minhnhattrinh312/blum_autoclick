...
class AutoClicker:
    def __init__(
        self, window_title, target_colors_hex, nearby_colors_hex, logger, percentages: float, is_continue: bool
    ):
                    ...
                    for target_hsv in self.target_hsvs:
                        ...
                        for contour in reversed(contours):
                            ...
                            if not self.is_near_color(
                                hsv, (cX - monitor["left"], cY - monitor["top"]), self.nearby_hsvs
                            ):
                                continue
...
if __name__ == "__main__":
    ...
    CLICK_IMAGES = [
        resource_path("media\\lobby-play.png"),
        resource_path("media\\continue-play.png"),
        resource_path("media\\continue_toma.png"),
    ]
    ...
    target_colors_hex = ["#fb4f78"]
    nearby_colors_hex = ["#fc4171"]
